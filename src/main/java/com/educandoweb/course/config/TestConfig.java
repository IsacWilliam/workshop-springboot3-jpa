...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Product p3 = new Product(null, "Macbook Pro", "Nam eleifend maximus tortor, at maollis.", 1250.0, "");
		Product p4 = new Product(null, "PC Gamer", "Donec aliquet odio ac rhoncus cursus.", 1200.0, "");
		Product p5 = new Product(null, "Rails for Dumies", "Cras fringilla convallis se, vel faucibus.", 100.99, "");
